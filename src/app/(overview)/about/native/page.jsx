        ...
        <div>
            ...
            <Container className="p-10">
                ...
                <p>
                    ...
                    один, а несколько преподавателей, которые будут передавать
                    свои знания в разных областях, создавать общее культурное
                    поле, на котором закрепится и разовьется русский язык.
                    Именно для этого мы собрали в Русской школе Сан Диего
